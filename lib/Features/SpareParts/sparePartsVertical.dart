...
import 'package:nmmcrevise/Features/SpareParts/sparePartsFilterBar.dart';
                    ...
                    FutureBuilder<List<dynamic>>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          ...
                          return /*Text('${snapshot.error.toString()}' */ CustomError(
                              azov: "Heil");
                        } else {
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => ProdPreviewSpecid(
